...
<body>
  ...
  <api-console json-file="api.json">
  ...
  (function() {
     ...
     */
    apiconsole.app.addListeners = function() {
      document.querySelector('api-console').addEventListener('json-file-loaded', function(e) {
        if (apiconsole.app.__initialPage && apiconsole.app.__initialPage !== e.target.page) {

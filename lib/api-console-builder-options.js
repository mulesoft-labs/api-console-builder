...
class ApiConsoleBuilderOptions {
  constructor(opts) {
     ...
     * Don't set when downloading the `api-console` element source code from GitHub.
     *
     * Defaults to `index.html`. Should point to a file that contains web components imports.
     */

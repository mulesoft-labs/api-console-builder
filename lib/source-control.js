...
class SourceControl {
  ...
  constructor(opts, logger) {
    ...
    /**
     * True if build in themplate has been used.
     * @type {Boolean}
     */
   ...
   * Otherwise it sets the `mainFile` option to the template that should be used. Also, sets
   * `usedTemplate` flag to determine if template files should be copied to the temp location.
   */
  setTemplates() {
   ...
   * This sets a `tmpDir` property on this object.
   *
   * TODO: `tmpDir` should not be set but passed to correcponding functions from project.
   *

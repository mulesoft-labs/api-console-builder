...
export class AmfSource {
   ...
   * @return {Promise<amf.model.document.BaseUnit>} Promise resolved to a model.
   */
   ...
   * @param {amf.model.document.BaseUnit} model json/ld model
   * @param {string} file Path to a file where to save the model.
   * @return {Promise<void>}
   */

  ...
  _initializeBuilder() {
    var options = {
      ...
      extraDependencies: [
        ...
        path.join(this.appSource, 'bower_components/raml-js-parser/raml-1-parser.js'),
        ...
        path.join(this.appSource, 'bower_components/xml-viewer/workers/**.js'),
        ...
        path.join(this.appSource, 'bower_components/raml-json-enhance/raml-object-worker.js'),
        path.join(this.appSource, 'bower_components/raml-js-parser/polyfills.js'),
        path.join(this.appSource, 'bower_components/raml-json-enhance/polyfills.js'),
        path.join(this.appSource, 'bower_components/raml-json-enhance/browser/*'),
        path.join(this.appSource, 'bower_components/raml-json-enhance/browser/**'),
        path.join(this.appSource, 'bower_components/raml-json-enhance/raml2object.js'),

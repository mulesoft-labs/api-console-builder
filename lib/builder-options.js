...
class BuilderOptions {
  ...
  get validOptions() {
    return [
      ...
      'noJsOptimization', 'tagVersion', 'mainFile', 'attributes', 'logger'
    ];
  }
  ...
  _setDefaults(opts) {
    ...
    var jsonFileAttribute = this.findAttribute('json-file', opts);
  ...
  _validateApiFileOptions(userOpts) {
    var jsonFileAttribute = this.findAttribute('json-file', userOpts);
